# Log in | Astria - Generative AI images | Astria — Captured Website

Source: https://www.astria.ai/prompts
...
| `extracted/tokens.json` | Design tokens: 8 colors, 1 fonts, 1 headings, 2 CTAs, 2 sections |
...
- **Colors**: #FFFFFF, #333C4D, #5266EB, #777777, #F2F2F2, #000000, #377CFB, #E5E5E5
- **Fonts**: Helvetica Neue
- **Sections**: 2 page sections detected
- **Headings**: 1 headings extracted
- **CTAs**: 2 calls-to-action found
